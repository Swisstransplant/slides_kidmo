...
## Swiss transplant centers {.scrollable}

![](centers.png){width=90%}
...
* Backward elimination with AIC (*p*&asymp;0.157) across 1,000 bootstraps^[Heinze & Dunkler, 2017, *Transpl Int*]
...
![Partial effects of the continuous variables (B) donor age, (C) recipient age, and (D) transplantation year on the graft loss rate.](partial_effects.png){width=90%}
...
Let's create 4 kidney recipients with varying kidney donor age, other factors being equal:
...
* Shiny app runs on **Posit Connect Cloud**
* Quarto website implements app with HTML `iframe`
* <https://data.swisstransplant.org/kidmo/>

:::: {.columns}

::: {.column width="50%"}

![](riskcalc.png){width=90%}
:::
